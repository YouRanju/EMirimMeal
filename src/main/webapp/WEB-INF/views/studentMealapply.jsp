...
<body>
	<div class="container">
		...
		<h1>급식신청</h1>
		<button onclick="checkTo()" class="btn btn-success">저장하기</button>
		...
		<form name="checkForm" method="post">
			<table class="table table-bordered">
				...
				<tr>
					<td><input type="checkbox" name="mon" class="mon"
						value="breakfast">조식<br> <input type="checkbox"
						name="mon" class="mon" value="lunch">중식<br> <input
						type="checkbox" name="mon" class="mon" value="dinner">석식<br>
					</td>
					<td><input type="checkbox" name="tue" class="tue"
						value="breakfast">조식<br> <input type="checkbox"
						name="tue" class="tue" value="lunch">중식<br> <input
						type="checkbox" name="tue" class="tue" value="dinner">석식<br>
					</td>
					<td><input type="checkbox" name="wed" class="wed"
						value="breakfast">조식<br> <input type="checkbox"
						name="wed" class="wed" value="lunch">중식<br> <input
						type="checkbox" name="wed" class="wed" value="dinner">석식<br>
					</td>
					<td><input type="checkbox" name="thu" class="thu"
						value="breakfast">조식<br> <input type="checkbox"
						name="thu" class="thu" value="lunch">중식<br> <input
						type="checkbox" name="thu" class="thu" value="dinner">석식<br>
					</td>
					<td><input type="checkbox" name="fri" class="fri"
						value="breakfast">조식<br> <input type="checkbox"
						name="fri" class="fri" value="lunch">중식<br> <input
						type="checkbox" name="fri" class="fri" value="dinner" disabled>석식<br>
					</td>
				</tr>
			</table>
		</form>
		<a href="${path }/emirimmeal/studentMeal">돌아가기</a> <img
			src="../resources/mirim.png">
	</div>
</body>
<script>
	...
	var enumcheck = [ [ false, false, false ], [ false, false, true ],
	...
	function checkTo() {
		...
		document.checkForm.action = '${path}/emirimmeal/studentMealApply/${state.no}/'
				+ submitMeal;
